                    ...
                    <div className="admin-item" style={{ width: "25em", marginLeft: "auto", marginRight: "auto", marginTop: "20px", justifyContent: "space-evenly" }}>
                        <form onSubmit={e => handleSubmit(e)}>
                            ...
                            <div className="profile-input" style={{ marginTop: "10px" }}>
                                Type: <input type="radio" name='category' id='Veg' value='Veg' style={{ width: "fit-content", marginLeft: "20px" }} required onChange={e => setType(e.target.value)} /> Designer
                                <input type="radio" name='category' id='Non Veg' value='Non Veg' style={{ width: "fit-content", marginLeft: "30px" }} onChange={e => setType(e.target.value)} /> Regular
                            </div>
                            <div className="profile-input" style={{ marginTop: "10px" }}>
                                Category:
                                <select name="category" id="category" required value={category} onChange={e => setCategory(e.target.value)}>
                                    <option value="">Select the category</option>
                                    <option value="pizza">BANGLES</option>
                                    <option value="Burger">CHAINS</option>
                                    <option value="Sandwich">RINGS</option>
                                    <option value="Smoothy">EARRRINGS</option>
                                    <option value="Snaks">LONG CHAINS</option>
                                    <option value="Drink">NECKLACES</option>
                                </select>
                            </div>
                            <div className="profile-input">
